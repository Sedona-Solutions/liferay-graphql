...
public class AssetVocabularyResolversImplTest {
    ...
    public void getAssetVocabulariesDataFetcher_should_return_the_specified_number_of_objects() throws Exception {
        ...
        // Asserts
        List<AssetVocabulary> results = resolvers.getAssetVocabulariesDataFetcher().get(environment);
    ...
    public void getAssetVocabularyDataFetcher_should_return_the_searched_object() throws Exception {
        ...
        // Asserts
        CompletableFuture<AssetVocabulary> asyncResult = resolvers.getAssetVocabularyDataFetcher().get(mockEnvironment);
    ...
    public void createAssetVocabularyDataFetcher_should_return_new_object() throws Exception {
        ...
        // Asserts
        AssetVocabulary result = resolvers.createAssetVocabularyDataFetcher().get(environment);
        assertNotNull(result);
        assertEquals(expectedResult, result);
    }
    ...
    public void updateAssetVocabularyDataFetcher_should_return_updated_object() throws Exception {
        ...
        // Asserts
        AssetVocabulary result = resolvers.updateAssetVocabularyDataFetcher().get(environment);
        assertNotNull(result);
        assertEquals(expectedResult, result);
    }

    @Test(expected = NoSuchVocabularyException.class)
    public void updateAssetVocabularyDataFetcher_with_no_assetVocabulary_id_should_return_null_with_exception() throws Exception {
        // Given
        Map<String, Object> arguments = new HashMap<>();
        arguments.put("groupId", GROUP_ID);
        arguments.put("title", TITLE);
    ...
    @Test(expected = NoSuchVocabularyException.class)
    public void updateAssetVocabularyDataFetcher_with_invalid_assetVocabulary_id_should_return_null_with_exception() throws Exception {
        // Given
        Map<String, Object> arguments = new HashMap<>();
    ...
    public void deleteAssetVocabularyDataFetcher_should_return_deleted_object() throws Exception {
        ...
        // Asserts
        AssetVocabulary result = resolvers.deleteAssetVocabularyDataFetcher().get(environment);
        assertNotNull(result);
        assertEquals(expectedResult, result);
    }
